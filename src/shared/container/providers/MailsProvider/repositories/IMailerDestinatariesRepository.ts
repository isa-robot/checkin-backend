...
export default interface IMailerDestinatariesRepository{
  ...
  findDestinatariesByType(type: string): Promise<MailerDestinataries[]>;
  findDestinatariesByTypeByAddress(type: string, address: string): Promise<MailerDestinataries | undefined>
